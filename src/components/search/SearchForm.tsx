...
import { Capacity } from './inputs/Capacity';
import { DatePickerWithRange } from './inputs/DatePickerWithRange';
...
export const SearchForm = ({ className, from, children }: Props) => {
  ...
  const search = useSearch({ from: from as any ?? OfficesRoute.fullPath });
